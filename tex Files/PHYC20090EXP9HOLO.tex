...
\begin{figure}[H]
    ...
    \caption{Comparison betwen fringe intesity (interferometry) as calculated with (a) digital holography, (b) transmission holography, (c) reflection holography \protect\cite{Olchewsky17}.}
    \label{fig:10}
\end{figure}
