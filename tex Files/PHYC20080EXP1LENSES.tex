...
\begin{table}[H]
    ...
    \hline
    \begin{tabular}[c]{@{}c@{}}\textbf{Angle of}\\ \textbf{Incidence} $\mathbf{(^{\circ})}$\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{Measured Reflected}\\ \textbf{Voltage (mV)}\end{tabular} \\ \hline
    0                                                                                                    & 54.6                                                                                        \\ \hline
    20                                                                                                   & 6.2                                                                                         \\ \hline
    30                                                                                                   & 8.38                                                                                        \\ \hline
    40                                                                                                   & 11.5                                                                                        \\ \hline
    ...
    \caption{\centering Value recorded for the laser light source polarised perpendicular to the plane of incidence.}
    \label{tab:6}
\end{table}
...
So the calculated value for the refractive index of the material of the lens used is $\mathbf{n=0.914}$.

\subsubsection{Parallel Polarisation} \label{sec:3.2.2}

The values for the reflected light at different angles of incidence for parallel polarisation were found and recorded below:
...
\begin{minipage}{.45\textwidth}
    \captionsetup{hypcap=false}
    \centering
    \includegraphics[width=\linewidth]{lenscode1.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.1} of this report.}

    \vspace{1cm}

    \includegraphics[width=\linewidth]{lenscode4.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.1.2} of this report.}

    \vspace{1cm}

    \includegraphics[width=\linewidth]{lenscode5.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.2.1} of this report.}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
    \captionsetup{hypcap=false}
    \centering
    \includegraphics[width=\linewidth]{lenscode3.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.1.1} of this report.}

    \vspace{1cm}

    \includegraphics[width=\linewidth]{lenscode6.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.2.2} of this report.}

    \vspace{1cm}

    \includegraphics[width=\linewidth]{lenscode7.png}
    \captionof{figure}{\centering Code used for §\ref{sec:3.2} of this report.}
\end{minipage}
